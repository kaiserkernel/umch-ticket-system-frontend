...
const Exam = ({ selectedTicket }) => {
  return (
    <div className="text-black">
      ...
      <Row>
        <Col lg={6}>
          <p className="text-black fw-bold">Teacher's name:</p>
          <p className="text-black">{selectedTicket?.details?.teacherName}</p>
        </Col>
        <Col lg={6}>
          <p className="text-black fw-bold">Module:</p>
          <p className="text-black">{selectedTicket?.details?.module}</p>
        </Col>
      </Row>
      <Row>
        <Col lg={12}>
