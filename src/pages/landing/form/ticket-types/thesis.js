...
const Thesis = () => {
      ...
      if (isFormSubmit != 0) {
        if (validate()) {
          if (Object.keys(mainPageErrors).length == 0) {
            ...
            formDataToSend.append("subCategory1", "Thesis");
  ...
  const validate = () => {
    ...
    if (formDetailData.titleOfThesis == "") {
      newErrors.titleOfThesis = "This field is required";
    }
    if (!formDetailData.subject) {
      newErrors.subject = "This field is required";
    }
    if (formDetailData.coordinatorOfHospital == "") {
      newErrors.coordinatorOfHospital = "This field is required";
    }
    if (!formDetailData.coordinatorOfFaculty) {
      newErrors.coordinatorOfFaculty = "This field is required";
    }
        ...
        <Col lg={6}>
          <Form.Group controlId="firstName">
            ...
            <Form.Control
              ...
              placeholder=""
              name="titleOfThesis"
              value={formDetailData.titleOfThesis}
              onChange={handleChange}
              className="custom-input"
            />
          </Form.Group>
          {errors.titleOfThesis && (
            <p className="error-content">{errors.titleOfThesis}</p>
          )}
        </Col>
        <Col lg={6}>
        ...
        <Col lg={6}>
          <Form.Group controlId="firstName">
            ...
            <Form.Control
              type="text"
              placeholder=""
              name="coordinatorOfHospital"
              value={formDetailData.coordinatorOfHospital}
              onChange={handleChange}
              className="custom-input"
            />
          </Form.Group>
          {errors.coordinatorOfHospital && (
            <p className="error-content">{errors.coordinatorOfHospital}</p>
          )}
        </Col>
        <Col lg={6}>
          <Form.Group controlId="lastName">
            ...
            <Form.Control
              type="text"
              placeholder=""
              name="coordinatorOfFaculty"
              value={formDetailData.coordinatorOfFaculty}
              onChange={handleChange}
              className="custom-input"
            />
          </Form.Group>
          {errors.coordinatorOfFaculty && (
            <p className="error-content">{errors.coordinatorOfFaculty}</p>
          )}
        </Col>
      </Row>
      <Row className="mt-5">
