...
const ShortTermBorrowDiploma = ({ applicationRequest }) => {
  ...
  const validate = () => {
    ...
    if (!formDetailData.diplomaCollectionDate) {
      newErrors.diplomaCollectionDate = "This field is required";
    }

    if (applicationRequest === "Short term borrow of Diploma")
      setErrors(newErrors);
        ...
        <Col lg={6}>
          <Form.Group controlId="">
            <Form.Label className="input-label">
              Date of diploma collection
              <span className="ms-1 required-label">*</span>
            </Form.Label>
            <StyledDatePicker
              selected={formDetailData.diplomaCollectionDate}
              onChange={(date) =>
                setformDetailData({
                  ...formDetailData,
                  diplomaCollectionDate: date
                })
              }
