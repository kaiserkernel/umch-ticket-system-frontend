...
const FormSection = () => {
  ...
  return (
    <section className="form py-2 py-md-5">
      <Container>
        <Row>
          <Col md={12}>
            <div className="bg-gray mt-2 mt-md-4 p-2 p-md-5">
              ...
              <Form className="mt-2 mt-md-5">
                ...
                <div className="d-flex  mt-2 mt-md-5">
                ...
                <p className="mt-2 mt-md-5">Best regards</p>
                <p>UMFST-UMCH</p>
                <div className="text-center">
                  <a className="mt-3 btn btn-primary rounded-pill px-4 py-2 default-bg">
                    Send Request
                  </a>
                </div>
              </Form>
